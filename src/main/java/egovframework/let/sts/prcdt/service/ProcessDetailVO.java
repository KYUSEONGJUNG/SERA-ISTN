 ...
 *  </pre>
 */
public class ProcessDetailVO extends ComDefaultVO implements Serializable {
...
//	private String comment	= "";
	...
	/**
	 * @return the testCompleteDate
	 */
	public String getTestCompleteDate() {
		return testCompleteDate;
	}
	/**
	 * @param testCompleteDate the testCompleteDate to set
	 */
	...
	/**
	 * @return the responserName
	 */
	public String getResponserName() {
		return responserName;
	}
	/**
	 * @param responserName the responserName to set
	 */
