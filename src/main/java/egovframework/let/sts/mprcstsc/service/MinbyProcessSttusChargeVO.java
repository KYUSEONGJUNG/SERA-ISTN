 ...
 *  </pre>
 */
public class MinbyProcessSttusChargeVO extends ComDefaultVO implements Serializable {
	...
	/**
	 * @return the searchDateCondition
	 */
	public String getSearchDateCondition() {
		return searchDateCondition;
	}
	/**
	 * @param searchDateCondition the searchDateCondition to set
	 */
	public void setSearchDateCondition(String searchDateCondition) {
		this.searchDateCondition = searchDateCondition;
	}
	/**
	 * @return the searchCountCondition
	 */
	public String getSearchCountCondition() {
		return searchCountCondition;
	}
	/**
	 * @param searchCountCondition the searchCountCondition to set
	 */
	public void setSearchCountCondition(String searchCountCondition) {
		this.searchCountCondition = searchCountCondition;
	}
	/**
	 ...
	 * @return the feb1
	 */
	public String getFeb1() {
		return feb1;
	}
	/**
	 * @param feb1 the feb1 to set
	 */
	public void setFeb1(String feb1) {
		this.feb1 = feb1;
	}
	/**
	 * @return the mar1
	...
	/**
	 * @param apr1 the apr1 to set
	 */
	public void setApr1(String apr1) {
		this.apr1 = apr1;
	}
	/**
	 * @return the may1
	 */
	public String getMay1() {
		return may1;
	}
	/**
	 * @param may1 the may1 to set
	 */
	public void setMay1(String may1) {
		this.may1 = may1;
	}
	/**
	 * @return the jun1
	 */
	public String getJun1() {
		return jun1;
	}
	/**
	 * @param jun1 the jun1 to set
	 */
	public void setJun1(String jun1) {
		this.jun1 = jun1;
	}
	/**
	 * @return the jul1
	 */
	public String getJul1() {
		return jul1;
	}
	/**
	 * @param jul1 the jul1 to set
	 */
	public void setJul1(String jul1) {
		this.jul1 = jul1;
	}
	/**
	 * @return the aug1
	 */
	public String getAug1() {
		return aug1;
	}
	/**
	 * @param aug1 the aug1 to set
	 */
	public void setAug1(String aug1) {
		this.aug1 = aug1;
	}
	/**
	 * @return the sep1
	 ...
	 * @return the nov1
	 */
	public String getNov1() {
		return nov1;
	}
	/**
	 * @param nov1 the nov1 to set
	 */
	public void setNov1(String nov1) {
		this.nov1 = nov1;
	}
	/**
	 * @return the dec1
