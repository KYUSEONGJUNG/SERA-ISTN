 ...
 *  </pre>
 */
@Repository("stsfdgSttusDAO")
public class StsfdgSttusDAO extends EgovAbstractDAO {

	/**
	 * SR처리율을 조회한다.
	 * @param vo StsfdgSttusVO
	 * @return List
	 * @exception Exception
	 */
    @SuppressWarnings("unchecked")
	public List selectStsfdgSttus(StsfdgSttusVO vo) throws Exception {
        return list("StsfdgSttusDAO.selectStsfdgSttus", vo);
    }
    ...
    public int selectStsfdgSttusTotCnt(StsfdgSttusVO vo) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("StsfdgSttusDAO.selectStsfdgSttusTotCnt", vo);
    }
    ...
    public List excelDownSrStsfdgSttusReportList(StsfdgSttusVO vo) throws Exception {
        return list("StsfdgSttusDAO.excelDownSrStsfdgSttusReportList", vo);
    }    
}
