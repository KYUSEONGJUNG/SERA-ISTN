 ...
 *  </pre>
 */
public class ProcessRateVO extends ComDefaultVO implements Serializable {
	...
	/** 엑셀-질문건수 */
	private String srTotalCnt           = "";
	/** 엑셀-접수건수 */
	private String signCnt           = "";
	/** 엑셀-신청건수 */
	private String requestCnt           = "";
	/** 엑셀-해결건수 */
	private String resolveCnt           = "";
	/** 엑셀-고객확인건수 */
	private String testAtCnt           = "";
	/** 엑셀-완료건수 */
	...
	/**
	 * @return the srTotalCnt
	 */
	public String getSrTotalCnt() {
		return srTotalCnt;
	}
	/**
	 * @param srTotalCnt the srTotalCnt to set
	 */
	public void setSrTotalCnt(String srTotalCnt) {
		this.srTotalCnt = srTotalCnt;
	}
	/**
	 * @return the signCnt
	 */
	...
	/**
	 * @param signCnt the signCnt to set
	 */
	public void setSignCnt(String signCnt) {
		this.signCnt = signCnt;
	}
	/**
	 * @return the requestCnt
	 */
	public String getRequestCnt() {
		return requestCnt;
	}
	/**
	 * @param requestCnt the requestCnt to set
	 */
	public void setRequestCnt(String requestCnt) {
		this.requestCnt = requestCnt;
	}
	/**
	 * @return the resolveCnt
	 */
	public String getResolveCnt() {
		return resolveCnt;
	}
	/**
	 * @param resolveCnt the resolveCnt to set
	 */
	public void setResolveCnt(String resolveCnt) {
		this.resolveCnt = resolveCnt;
	}
	/**
	 * @return the completeCnt
	 */
	public String getCompleteCnt() {
		return completeCnt;
	}
	/**
	 * @param completeCnt the completeCnt to set
	 */
	...
	/**
	 * @param evalCnt the evalCnt to set
	 */
	...
	public String getTestAtCnt() {
		return testAtCnt;
	}
	public void setTestAtCnt(String testAtCnt) {
		this.testAtCnt = testAtCnt;
	}
