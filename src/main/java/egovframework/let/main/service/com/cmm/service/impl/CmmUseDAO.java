package egovframework.let.main.service.com.cmm.service.impl;
...
public class CmmUseDAO extends EgovComAbstractDAO {
     ...
     */
    @SuppressWarnings("unchecked")
    public List<CmmnDetailCode> selectCstmrDetail(ComDefaultCodeVO vo) throws Exception {
	return (List<CmmnDetailCode>) list("CmmUseDAO.selectCstmrDetail", vo);
    }
	 ...
	 * @return Sr(고객사)
	 */
	public String selectCodeNm(ComDefaultCodeVO vo) throws Exception {
		return (String) selectByPk("CmmUseDAO.selectCodeNm", vo);
	}
}
