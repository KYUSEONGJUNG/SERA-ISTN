...
public class SessionVO implements Serializable {
	...
	public String getStrservicelvl() {
		return strservicelvl;
	}
	public void setStrservicelvl(String strservicelvl) {
		this.strservicelvl = strservicelvl;
	}
	public String getsUserId() {
		return sUserId;
	}
	...
	public void setsUserSe(String sUserSe) {
		this.sUserSe = sUserSe;
	}
