...
public class EgovRoleManageController {
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/select/sec/rmt/EgovRoleList.do")
    @ResponseBody
	public Map<String, Object> selectRoleListMap(@ModelAttribute("roleManageVO") RoleManageVO roleManageVO, 
			                      ModelMap model) throws Exception {
		...
		roleManageVO.setRoleManageList(egovRoleManageService.selectRoleList(roleManageVO));
        //model.addAttribute("roleList", roleManageVO.getRoleManageList());
        //retMap.put("roleList", roleManageVO.getRoleManageList());
        
        List<RoleManageVO> roleManageList = roleManageVO.getRoleManageList();
        List<Map<String, Object>> roleList = new ArrayList<Map<String,Object>>();
        
    	for(int i=0 ; i < roleManageList.size() ; i++) {
        	
        	Map<String, Object> resultMap = new HashMap<String, Object>();
        	resultMap.put("roleCode", roleManageList.get(i).getRoleCode());
        	resultMap.put("roleNm", roleManageList.get(i).getRoleNm());
        	resultMap.put("roleTyp", roleManageList.get(i).getRoleTyp());
        	resultMap.put("roleSort", roleManageList.get(i).getRoleSort());
        	resultMap.put("roleDc", roleManageList.get(i).getRoleDc());
        	resultMap.put("roleCreatDt", roleManageList.get(i).getRoleCreatDe());
        	resultMap.put("delYn", roleManageList.get(i).getDelYn());
        	
        	roleList.add(resultMap);
        }
