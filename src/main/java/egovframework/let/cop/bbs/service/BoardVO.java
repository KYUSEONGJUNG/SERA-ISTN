...
public class BoardVO extends Board implements Serializable {
    ...
    //---------------------------------	
    // 2014.03.27 : 생성자ID, 업체코드로 조회 추가.(고객게시판용)
    //---------------------------------
    /** 검색-생성자ID */
	...
	/**
	 * @param searchCreatorId the searchCreatorId to set
	 */
	public void setSearchCreatorId(String searchCreatorId) {
