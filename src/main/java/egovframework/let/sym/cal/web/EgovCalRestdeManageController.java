...
public class EgovCalRestdeManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/ccm/EgovNormalCalPopup.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/ccm/EgovselectNormalCalendar.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/ccm/EgovAdministCalPopup.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/ccm/EgovselectAdministCalendar.do")
