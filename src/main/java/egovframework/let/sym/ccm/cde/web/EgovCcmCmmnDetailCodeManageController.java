...
public class EgovCcmCmmnDetailCodeManageController {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/select/sym/ccm/cde/EgovCcmCmmnDetailCodeList.do")
    @ResponseBody
	public Map<String, Object> selectCmmnDetailCodeListMap (@ModelAttribute("loginVO") LoginVO loginVO
			, @ModelAttribute("searchVO") CmmnDetailCodeVO searchVO
			, ModelMap model
			) throws Exception {
        ...
        //model.addAttribute("resultList", cmmnDetailCodeManageService.selectCmmnDetailCodeList(searchVO));
        retMap.put("resultList", cmmnDetailCodeManageService.selectCmmnDetailCodeList(searchVO));
