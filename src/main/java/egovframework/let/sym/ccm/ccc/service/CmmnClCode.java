...
public class  CmmnClCode implements Serializable {
	...
	public String getSearchClCodeNm() {
		return searchClCodeNm;
	}

	public void setSearchClCodeNm(String searchClCodeNm) {
		this.searchClCodeNm = searchClCodeNm;
	}
