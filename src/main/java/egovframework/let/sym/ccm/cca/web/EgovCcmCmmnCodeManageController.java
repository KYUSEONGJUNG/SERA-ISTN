...
public class EgovCcmCmmnCodeManageController {
    ...
    private EgovSndngMailService  sndngMailService;
	...
	@RequestMapping(value="/sym/ccm/cca/EgovCcmCmmnCodeDetail.do")
 	public String selectCmmnCodeDetail (@ModelAttribute("loginVO") LoginVO loginVO
		...
		CmmnCode vo =cmmnCodeManageService.selectCmmnCodeDetail(searchVO);
    ...
    /**
        ...
        * @throws Exception
        */
       @RequestMapping(value="/select/sym/ccm/cca/EgovCcmCmmnCodeList.do")
       @ResponseBody
   	public Map<String, Object> selectEgovCmmnCodeList (@ModelAttribute("loginVO") LoginVO loginVO
   			, @ModelAttribute("searchVO") CmmnCodeVO searchVO
   			, ModelMap model
   			) throws Exception {
           ...
           model.addAttribute("resultList", cmmnCodeManageService.selectCmmnCodeList(searchVO));
           retMap.put("resultList", cmmnCodeManageService.selectCmmnCodeList(searchVO));
	 ...
	 * @throws Exception
	 */
    @RequestMapping(value="/sym/ccm/cca/EgovCcmCmmnSendMail.do")
	public String testSendMail (@ModelAttribute("loginVO") LoginVO loginVO
			, @ModelAttribute("searchVO") CmmnCodeVO searchVO
			, BindingResult bindingResult
			, Map commandMap
			, ModelMap model
    	...
    	SndngMailVO snVo = new SndngMailVO();
    	snVo.setMssageId("12345");
    	snVo.setDsptchPerson("78hjm@isprint.co.kr");		// 발신자
    	snVo.setRecptnPerson("hiyeat@naver.com");	// 수신자
    	snVo.setSj("Test 메일입니다.");					// 제목
    	snVo.setEmailCn("Test 내용입니다.");				// 내용
    	
//    	sndngMailService.sndngMail(snVo);
