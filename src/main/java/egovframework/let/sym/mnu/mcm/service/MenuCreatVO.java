 ...
 * </pre>
 */
public class MenuCreatVO extends ComDefaultVO {
   ...
   private   String   creatPersonId;
	...
	/** 검색-권한코드 */
	private String searchAuthorCode;	
	/** 검색-권한명 */
	private String searchAuthorNm;
	...
	public String getSearchAuthorCode() {
		return searchAuthorCode;
	}
	public void setSearchAuthorCode(String searchAuthorCode) {
		this.searchAuthorCode = searchAuthorCode;
	}
	public String getSearchAuthorNm() {
		return searchAuthorNm;
	}
	public void setSearchAuthorNm(String searchAuthorNm) {
		this.searchAuthorNm = searchAuthorNm;
	}
