...
public class EgovMenuCreateManageController {
	...
	public String selectMenuCreatManagList(
			@ModelAttribute("searchVO") MenuCreatVO searchVO, ModelMap model)
			throws Exception {
		String resultMsg = "";
...
//		model.addAttribute("resultMsg", resultMsg);
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/select/sym/mnu/mcm/EgovMenuCreatManageSelect.do")
	@ResponseBody
	public Map<String, Object> selectMenuCreatManagListMap(
			@ModelAttribute("searchVO") MenuCreatVO searchVO, ModelMap model)
			throws Exception {
...
//		}
		//model.addAttribute("list_menumanage", menuCreateManageService.selectMenuCreatManagList(searchVO));
		retMap.put("resultList",menuCreateManageService.selectMenuCreatManagList(searchVO));
		int totCnt = menuCreateManageService.selectMenuCreatManagTotCnt(searchVO);
		paginationInfo.setTotalRecordCount(totCnt);
		model.addAttribute("paginationInfo", paginationInfo);
...
//		model.addAttribute("resultMsg", resultMsg);
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "select/sym/mnu/mcm/EgovMenuCreatSelect.do")
	@ResponseBody
	public Map<String, Object> selectMenuCreatListMap(
			@ModelAttribute("menuCreatVO") MenuCreatVO menuCreatVO,
			ModelMap model) throws Exception {
		Map<String, Object> retMap = new HashMap<String, Object>();
		// 0. Spring Security 사용자권한 처리
		...
		retMap.put("resultList", menuCreateManageService.selectMenuCreatList(menuCreatVO));
		retMap.put("resultVO", menuCreatVO);
	 ...
	 * @exception Exception
	 */
	@RequestMapping("/insert/sym/mnu/mcm/EgovMenuCreatInsert.do")
	@ResponseBody
	public Map<String, Object> insertMenuCreatListMap(
			@RequestParam("checkedAuthorForInsert") String checkedAuthorForInsert,
			@RequestParam("checkedMenuNoForInsert") String checkedMenuNoForInsert,
			@ModelAttribute("menuCreatVO") MenuCreatVO menuCreatVO,
			ModelMap model) throws Exception {
