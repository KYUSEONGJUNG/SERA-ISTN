...
public interface EgovMenuManageService {
	 ...
	 * @exception Exception
	 */
	int selectMenuManageListTotCnt(MenuManageVO vo) throws Exception;
	...
	/**
	 * MainMenu Head Child Left 조회
	 * @param vo MenuManageVO
	 * @return List
	 * @exception Exception
	 */
	@SuppressWarnings("unchecked")
	List selectMainChildMenuLeft(MenuManageVO vo) throws Exception;
