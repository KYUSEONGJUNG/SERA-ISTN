...
//	CommonsMultipartResolver mailmultipartResolver;
	 ...
	 * @exception Exception
	 */
    public int selectMenuManageListTotCnt(MenuManageVO vo) throws Exception {
	...
	/**
	 * MainMenu Head Left Child 조회
	 * @param vo MenuManageVO
	 * @return List
	 * @exception Exception
	 */
	@SuppressWarnings("unchecked")
	public List selectMainChildMenuLeft(MenuManageVO vo) throws Exception {
   		return menuManageDAO.selectMainChildMenuLeft(vo);
	}
