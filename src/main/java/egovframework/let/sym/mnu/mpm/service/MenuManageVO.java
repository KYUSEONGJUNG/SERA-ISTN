...
public class MenuManageVO extends ComDefaultVO {
   ...
   private   String   tmp_Cmd;
	...
	public String getSearchMenuNo() {
		return searchMenuNo;
	}
	public void setSearchMenuNo(String searchMenuNo) {
		this.searchMenuNo = searchMenuNo;
	}
