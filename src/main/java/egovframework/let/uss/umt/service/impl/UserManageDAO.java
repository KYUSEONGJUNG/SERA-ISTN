...
public class UserManageDAO extends EgovAbstractDAO{
	...
	public List selectUserList(UserManageVO searchVO){
        return list("userManageDAO.selectUserList_S", searchVO);
    }
    ...
    public int selectUserListTotCnt(UserManageVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("userManageDAO.selectUserListTotCnt_S", searchVO);
    }
	...
	public List selectChargerList(UserManageVO searchVO){
        return list("userManageDAO.selectChargerList_S", searchVO);
    }
	...
	public List selectChargerNmList(UserManageVO searchVO){
        return list("userManageDAO.selectChargerNmList_S", searchVO);
    }

	public int selectEmailYn(UserManageVO userManageVO) {
		// TODO Auto-generated method stub
		return (Integer)getSqlMapClientTemplate().queryForObject("userManageDAO.selectEmailYn", userManageVO);
	}
