...
public interface EgovUserManageService  {
	...
	public List selectUserList(UserManageVO searchVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public int selectUserListTotCnt(UserManageVO searchVO) throws Exception;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List selectChargerList(UserManageVO searchVO) throws Exception;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List selectChargerNmList(UserManageVO searchVO) throws Exception;
