...
<div id="container">
    <div id="container_con">
    	<div id="error">
<%--     	  <img src="<c:url value='/' />images/sr/img_error01.gif" border="0" usemap="#Map1" /> --%>
<!--           <map name="Map1" id="Map"> -->
<!--             <area shape="rect" coords="496,181,559,210" href="javascript:fncGoAfterErrorPage();" /> -->
<!--           </map> -->
        <c:choose>
          <c:when test="${language == 'ko'}">
	      	  <img src="<c:url value='/' />images/sr/img_error01.gif" border="0" usemap="#Map3" />
          </c:when>
          <c:when test="${language == 'en'}">
	      	  <img src="<c:url value='/' />images/sr/img_error01En.gif" border="0" usemap="#Map3" />
          </c:when>
          <c:when test="${language == 'cn'}">
	      	  <img src="<c:url value='/' />images/sr/img_error01Cn.gif" border="0" usemap="#Map3" />
          </c:when>
          <c:otherwise>
	      	  <img src="<c:url value='/' />images/sr/img_error01.gif" border="0" usemap="#Map3" />
          </c:otherwise>
