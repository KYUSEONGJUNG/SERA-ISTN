...
<!--                     </div>                   -->
                    ...
                    <div id="login_title_div"><img alt="LOGIN SR 시스템에 오신것을 환영합니다." src="<c:url value='/' />images/login/img_logintitle.gif" /></div>        
                        <div class="user_login">
                        <form:form name="loginForm" method="post" id="loginForm">
                                ...
                                <div class="user_login_ultop">
                                    <ul>
                                        <li>
                                            ...
                                            <input type="text" class="input_style" title="아이디를 입력하세요." id="id" name="id" maxlength="10" style="ime-mode:inactive" />
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <input type="checkbox" name="checkPw" title="로그인패스워드 저장여부" onclick="javascript:savepassword(this.form);" id="checkPw" />비밀번호저장
                                            <font size=2 class='.location'><a href=javascript:fCallUrl('<c:url value='/uat/uia/egovIdPasswordSearch.do'/>');>ID/PW찾기</a>
                                        </li>
                                    </ul>
