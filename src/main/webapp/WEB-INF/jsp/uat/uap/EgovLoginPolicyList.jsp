    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="contents">
                ...
                <!-- table add start -->
                <div class="list3">
                    <table width="980" border="0" cellpadding="0" cellspacing="0" summary="로그인정책에 대한 목록을 제공한다." cellpadding="0" cellspacing="0">
<%--                     <caption></caption> --%>
                    <colgroup>
                    <col width="20%" >
                    <col width="25%" >  
                    ...
                    <!-- loop 시작 -->                                
                      <tr>
					    ...
					    <td nowrap="nowrap" class="tdwc"><c:out value="${loginPolicy.emplyrNm}"/></td>
					    <td nowrap="nowrap" class="tdwc"><c:out value="${loginPolicy.ipInfo}"/></td>
					    <td nowrap="nowrap" class="tdwc"><c:if test="${loginPolicy.lmttAt == 'Y'}">Y</c:if><c:if test="${loginPolicy.lmttAt == 'N'}">N</c:if></td>
                      </tr>
                      <tr>
						    <td colspan="4" bgcolor="#cdcdcd" height="1"></td>
						</tr>
                     ...
                     <c:if test="${fn:length(loginPolicyList) == 0}">
                      <tr>
                        <td nowrap colspan="4"><spring:message code="common.nodata.msg" /></td>  
                      </tr>      
                     </c:if>  
                    </tbody>
                    </table>
