...
<!-- 			    </div>	 -->
    ...
    <!-- table add start -->
    <div class="list3">
        <table width="980" border="0" cellpadding="0" cellspacing="0" summary="번호, 템플릿명, 템플릿구분, 템플릿경로, 사용여부, 등록일자, 선택   목록입니다" cellpadding="0" cellspacing="0">
<%--         <caption>사용자목록관리</caption> --%>
        ...
        <!-- loop 시작 -->                                
             <tr>
               ...
               <td nowrap="nowrap" class="tdwc"><c:out value="${result.tmplatNm}"/></td>
