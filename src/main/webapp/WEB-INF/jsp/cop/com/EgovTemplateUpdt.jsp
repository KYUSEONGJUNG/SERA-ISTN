...
<!--                 </div> -->
                ...
                <div class="list2">
			      	<ul>
			        	<li><img src="<c:url value='/' />images/sr/icon_home.gif"/> &nbsp;HOME > 게시판관리 > 게시판템플릿관리 > 게시판템플릿 수정</li>
			        </ul>
			    </div>	
                ...
                <form:form commandName="templateInf" name="templateInf" method="post" >
                    ...
                    <div class="inputtb" >
                        <table width="980" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr> 
                            <th width="20%" height="23" class="tdblue" nowrap ><spring:message code="cop.tmplatNm" /></th>
                    ...
                    <div class="list4">
                    	<span class="btnblue"><a href="#LINK" onclick="javascript:fn_egov_update_tmplatInfo(); return false;"><spring:message code="button.save" /> ▶</a></span>&nbsp;
                    	<span class="btnblue"><a href="<c:url value='/cop/com/selectTemplateInfs.do'/>" onclick="javascript:fn_egov_select_tmplatInfo(); return false;"><spring:message code="button.list" /> ▶</a></span>&nbsp;
                    	<span class="btnblue"><a href="#LINK" onclick="javascript:fn_egov_previewTmplat(); return false;" ><spring:message code="cop.preview" /> ▶</a></span>&nbsp;
                    </div>
                    <!-- 버튼 끝 --> 
