                ...
                <div class="searchtb2">
                	...
                	<table width="980" border="0" cellpadding="0" cellspacing="0">
			            ...
			            <tr>
			              ...
			              <td align="center"><a href="<c:url value='/cop/com/selectBBSUseInfs.do'/>" onclick="fn_egov_select_bbsUseInfs('1'); return false;"><img src="<c:url value='/' />images/sr/btn_search2.gif"/></a></td>
			            </tr>
			            <tr>
...
<!--                 </div> -->
			    ...
			    <div class="list2">
			      	<ul>
			        	<li><img src="<c:url value='/' />images/sr/icon_home.gif"/> &nbsp;HOME > 게시판관리 > 게시판사용관리</li>
			        </ul>
			      </div>                      
                <!-- table add start -->
                <div class="list3">
...
<%--                     <caption>사용자목록관리</caption> --%>
                    ...
                    <!-- loop 시작 -->                                
                      <tr>
				        ...
				        <td nowrap="nowrap" class="tdwc"><c:out value="${result.cmmntyNm}"/></td>
				        <td nowrap="nowrap" class="tdwc"><c:out value="${result.clbNm}"/></td>    
                    ...
                    <table width="980" border="0" cellpadding="0" cellspacing="0">
			        	...
			        	<tr>
			                ...
			                <span class="btnblue"><a href="<c:url value='/cop/com/addBBSUseInf.do'/>" onclick="fn_egov_insert_addbbsUseInf(); return false;"><spring:message code="button.create" /> ▶</a></span>&nbsp;
			                </td>
			            </tr>
			        </table>                      
