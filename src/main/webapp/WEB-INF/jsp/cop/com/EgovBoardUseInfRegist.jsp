...
<!--                 </div> -->
                ...
                <div class="list2">
			      	<ul>
			        	<li><img src="<c:url value='/' />images/sr/icon_home.gif"/> &nbsp;HOME > 게시판관리 > 게시판사용관리 > 게시판 사용등록</li>
			        </ul>
			    </div>	
...
<!--                 </div> -->
				<form:form commandName="boardUseInf" name="boardUseInf" method="post">
                    ...
                    <div class="inputtb" >
                        <table width="980" border="0" cellpadding="0" cellspacing="0" summary="게시판명, 커뮤니티 동호회 정보  입니다">
					      <tr>
						    <td colspan="4" bgcolor="#0257a6" height="2"></td>
						  </tr>
					      <tr>   
					        <th width="30%" height="23" class="tdblue" nowrap ><spring:message code="cop.bbsNm" /><img src="<c:url value='/images/required.gif' />" width="15" height="15" alt="required"/>
					        </th>
					      ...
					      <tr> 
					        <th width="30%" height="23" class="tdblue" nowrap >
					            <label for="trgetType">
                    ...
                    <div class="list4">
                    	<span class="btnblue"><a href="#LINK" onclick="JavaScript:fn_egov_regist_bbsUseInf(); "><spring:message code="button.save" /> ▶</a></span>&nbsp;
                    	<span class="btnblue"><a href="<c:url value='/cop/com/selectBBSUseInfs.do'/>?searchCondition=1" onclick="JavaScript:fn_egov_select_bbsUseInfs(); return false;"><spring:message code="button.list" /> ▶</a></span>&nbsp;
                    </div>
                    <!-- 버튼 끝 -->  
