                ...
                <div class="searchtb2">
                	...
                	<table width="980" border="0" cellpadding="0" cellspacing="0">
			            ...
			            <tr>
			              ...
			              <td align="center"><a href="<c:url value='/cop/bbs/SelectBBSMasterInfs.do'/>" onclick="JavaScript:fn_egov_select_brdMstr('1'); return false;" onclick="fn_egov_select_brdMstr('1'); return false;"><img src="<c:url value='/' />images/sr/btn_search2.gif"/></a></td>
			            </tr>
			            <tr>
...
<!--                 </div> -->
			    ...
			    <div class="list2">
			      	<ul>
			        	<li><img src="<c:url value='/' />images/sr/icon_home.gif"/> &nbsp;HOME > 게시판관리 > 게시판생성관리</li>
			        </ul>
			      </div>                      
                <!-- table add start -->
                <div class="list3">
                    <table width="980" border="0" cellpadding="0" cellspacing="0" summary="번호,게시판명,게시판유형,게시판속성,생성일,사용여부  목록입니다" cellpadding="0" cellspacing="0">
<%--                     <caption>사용자목록관리</caption> --%>
                    ...
                    <!-- loop 시작 -->                                
                      <tr>
                        ...
                        <td nowrap="nowrap" class="tdwc"><c:out value="${result.bbsTyCodeNm}"/></td>
                        <td nowrap="nowrap" class="tdwc"><c:out value="${result.bbsAttrbCodeNm}"/></td>
                    ...
                    <table width="980" border="0" cellpadding="0" cellspacing="0">
			        	...
			        	<tr>
			                ...
			                <span class="btnblue"><a href="<c:url value='/cop/bbs/addBBSMaster.do'/>" onclick="fn_egov_insert_addBrdMstr(); return false;"><spring:message code="button.create" /> ▶</a></span>&nbsp;
			                </td>
			            </tr>
			        </table> 
