		...
		<tr>
		  <td>
			...
			<CAPTION style="display: none;">발송메일 등록</CAPTION>
			  <tr>
			    <th scope="row" width="100" height="23" class="tdblue" nowrap ><label for="recptnPerson">받는사람</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
			    <td width="600" nowrap>
			  ...
			  <tr>
			    <th scope="row" width="100" height="23" class="tdblue" nowrap ><label for="sj">제목</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
			    <td width="600" nowrap>
			  ...
			  <tr>
			    <th scope="row" width="100" height="23" class="tdblue"><label for="egovComFileUploader">파일첨부&nbsp;&nbsp;&nbsp;</label></th>
			    <td width="600">
			  ...
			  <tr>
			    <th scope="row" width="100" height="23" class="tdblue" ><label for="emailCn">발신 내용&nbsp;&nbsp;&nbsp;</label></th>
			    <td width="600">
		  ...
		  <td>
			<table border="0" cellspacing="0" cellpadding="0" align="right">
			  <tr>
			    ...
			    <td style="background-image:URL(<c:url value='/images/egovframework/com/cmm/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#LINK" onclick="fnBack(); return false;">뒤로</a>
			    </td>
