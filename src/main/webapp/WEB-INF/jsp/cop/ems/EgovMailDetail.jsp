	    ...
	    <tr>
	      <td>
			...
			<CAPTION style="display: none;">발송메일 상세조회</CAPTION>
			  <tr> 
			    <th scope="row" width="200" height="23" class="tdblue" nowrap >보내는사람&nbsp;&nbsp;</th>
			    <td width="500" nowrap>${resultInfo.dsptchPerson}</td>
			  </tr>
			  <tr> 
			    <th scope="row" width="200" height="23" class="tdblue" nowrap >받는사람&nbsp;&nbsp;</th>
			    <td width="500" nowrap>${resultInfo.recptnPerson}</td>
			  </tr>
			  <tr> 
			    <th scope="row" width="200" height="23" class="tdblue" nowrap >제목&nbsp;&nbsp;</th>
			    <td width="500" nowrap>${resultInfo.sj}</td>
			  </tr>
			  <tr> 
			    <th scope="row" width="200" height="23" class="tdblue" >발신 내용&nbsp;&nbsp;</th>
			    <td width="500" nowrap>
			      <c:out value="${fn:replace(resultInfo.emailCn , crlf , '<br/>')}" escapeXml="false" />
			    </td>
			  </tr> 
			  <tr> 
			    <th scope="row" width="200" height="23" class="tdblue" >발송 결과&nbsp;&nbsp;</th>
			    <td width="500" nowrap>${resultInfo.sndngResultCode}</td>
			  </tr> 
			  <tr> 
			    <th scope="row" width="200" height="23" class="tdblue" >XML메일보기&nbsp;&nbsp;</th>
			    <td width="500" nowrap><a href="#LINK" onclick="fnSelectXml(); return false;">${resultInfo.mssageId}.xml</a></td>
			  </tr>
			  <c:if test="${result.atchFileId != ''}">
			  <tr> 
			    <th scope="row" width="200" height="23" class="tdblue" >첨부파일&nbsp;&nbsp;</th>
			    <td width="500" nowrap>
