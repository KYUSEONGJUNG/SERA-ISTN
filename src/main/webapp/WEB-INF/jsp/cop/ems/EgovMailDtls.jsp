		...
		<form name="listForm" action="<c:url value='/cop/ems/selectSndngMailList.do'/>" method="post">
			    ...
			    <th width="150">
			      <table border="0" cellspacing="0" cellpadding="0">
			        <tr>
				      ...
				      <td style="background-image:URL(<c:url value='/images/egovframework/com/cmm/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#LINK" onclick="fnDelete(); return false;">삭제</a>
				      </td>
			...
			<td class="lt_text3" colspan="6">
			  ...
			  <tr style="cursor:hand;">
			    ...
			    <td class="tdwc" nowrap>${resultInfo.sndngResultCode}</td>
			    <td class="tdwc" nowrap>${resultInfo.dsptchPerson}</td>
			    <td class="tdwc" nowrap>${resultInfo.recptnPerson}</td>
			    <td class="tdwc" nowrap><a href="<c:url value='/cop/ems/selectSndngMailDetail.do' />" onclick="fnDetail('${resultInfo.mssageId}'); return false;">${resultInfo.sj}</a></td>
			    <td class="tdwc" nowrap>${resultInfo.sndngDe}</td>
			  </tr>
			  </c:forEach>
			<!-- 목록 조회 끝-->
			</tbody>
