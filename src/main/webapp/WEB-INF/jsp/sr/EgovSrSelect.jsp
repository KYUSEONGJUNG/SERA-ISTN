...
<title><spring:message code='sr.navigation.srDetail'/></title>
	        ...
	        <div class="sr-contents">
	            ...
	            <form action="${pageContext.request.contextPath}/sr/EgovSrSelectUpdtSanctner.do" name="srVO" id = "srVO" method="post" enctype="multipart/form-data">
				 ...
				 <div class="btn_buttom"> 
	                <sbux-button id="button1" name="button1" uitype="normal" text="<spring:message code="button.delete" />" onclick="fnDelete();" class="btn-default"></sbux-button>                   
...
<%-- <div id="wrapper">
    ...
    <!-- container 시작 -->
            ...
            <div id="contents">
                <div class="list2">
			      	<ul>
			        	<li><img src="<c:url value='/' />images/sr/icon_home.gif"/> &nbsp;<spring:message code='sr.navigation.srDetail'/></li>
			        </ul>
			   </div>
                <!-- 검색 필드 박스 시작 -->
		        <form:form modelAttribute="srVO" action="${pageContext.request.contextPath}/sr/EgovSrSelectUpdtCstmr.do" name="srVO" method="post" enctype="multipart/form-data">
                    ...
                    <div class="inputtb" >
                        <table width="980" border="0" cellpadding="0" cellspacing="0" summary="SR, 업종코드, 업무명, 업체명 등을 가지고 있는 SR 상세조회(수정) 테이블이다.">
						  ...
						  <tr>
						    <th width="20%" height="23" class="tdblue"><spring:message code='cop.emailAdres'/>
						    	<img src="<c:url value='/'/>images/required.gif" width="15" height="15" alt="필수" />
						    </th>
						    <td width="30%" class="tdleft">
						  ...
						  <tr> 
						    ...
						    <td width="80%" colspan="3" class="tdleft">
						    	<textarea id="comment" name="comment" readOnly="true" cols="75" rows="20"  style="width:99%" readonly title="글내용">
						  ...
						  <tr>
                           ...
                           <c:if test="${srVO.returnResn != '' && srVO.returnResn != null}">
	                           <tr> 
							    <th width="20%" height="23" class="tdblue" scope="row" nowrap ><spring:message code='sr.reasonReturn'/></th>
							    <td width="80%" colspan="3">
					                <c:out value='${srVO.returnResn}'/>
							    </td>    
							  </tr>
