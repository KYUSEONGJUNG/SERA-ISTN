        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="contents">
                ...
                <form:form commandName="groupManage" method="post" >
                    ...
                    <div class="inputtb" >
                        <table width="980" border="0" cellpadding="0" cellspacing="0" summary="그룹을 수정하는 테이블입니다.그룹 ID,그룹 명,설명,등록일자 정보를 담고 있습니다.">
                          <tr>
                            <th class="tdblue" width="25%" scope="row"  nowrap="nowrap">그룹 ID
                            </th>
                            <td nowrap="nowrap"><input name="groupId" id="groupId" type="text" value="<c:out value='${groupManage.groupId}'/>" size="40" title="그룹 ID"/></td>
                          </tr>
                          <tr>    
                            <th class="tdblue" width="25%" scope="row"  nowrap="nowrap">그룹 명
