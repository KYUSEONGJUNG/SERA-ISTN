...
<%@ page import="egovframework.let.main.service.com.cmm.util.EgovUserDetailsHelper" %>
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <form:form name="listForm" action="<c:url value='/sec/gmt/EgovAuthorList.do'/>" method="post">
                ...
                <!-- table add start -->
                <div class="list3">
                    <table width="980" border="0" cellpadding="0" cellspacing="0" summary="그룹 관리에 관한 테이블입니다.그룹 ID,그룹 명,설명,등록일자의 정보를 담고 있습니다." cellpadding="0" cellspacing="0">
<%--                     <caption></caption> --%>
                    <colgroup>
                    <col width="3%" >
                    <col width="12%" >  
                    ...
                    <!-- loop 시작 -->                                
                      <tr>
					    ...
					    <td nowrap="nowrap" class="tdwc"><c:out value="${group.groupDc}"/></td>
					    <td nowrap="nowrap" class="tdwc"><c:out value="${group.groupCreatDe}"/></td>
					    <td nowrap="nowrap" class="tdwc"><a href="#LINK" onclick="javascript:fncSelectGroup('<c:out value="${group.groupId}"/>')"><img src="<c:url value='/images/img_search.gif'/>" width="15" height="15" align="middle" alt="상세조회"></a></td>
                      </tr>
                      <tr>
						    <td colspan="6" bgcolor="#cdcdcd" height="1"></td>
						</tr>
