...
<!--                 </div> -->
                ...
                <div class="list2">
			      	<ul>
			        	<li><img src="<c:url value='/' />images/sr/icon_home.gif"/> &nbsp;HOME > 사용자관리 > 권한코드관리 > <c:out value="${registerFlagName}"/></li>
			        </ul>
			   </div>
...
<!--                 </div> -->
                <form:form commandName="authorManage" method="post" >
                    ...
                    <div class="inputtb" >
                        <table width="980" border="0" cellpadding="0" cellspacing="0" summary="권한을 등록하는 테이블입니다.권한 코드,권한 명,설명,등록일자의 정보를 담고 있습니다.">
						  <tr>
			                <td colspan="4" bgcolor="#0257a6" height="2"></td>
			              </tr>
						  <tr>
						    <th class="tdblue" width="20%" scope="row" nowrap="nowrap">권한  코드
                               <img src="<c:url value='/'/>images/required.gif" width="15" height="15" alt="필수" />
                            </th>
						    <td nowrap="nowrap" class="tdleft"><input name="authorCode" id="authorCode" type="text" value="<c:out value='${authorManage.authorCode}'/>" size="40" title="권한코드" />&nbsp;<form:errors path="authorCode" /></td>
						  ...
						  <tr>  
						    <th class="tdblue" width="20%" scope="row" nowrap="nowrap">권한 명
                                <img src="<c:url value='/'/>images/required.gif" width="15" height="15" alt="필수" />
                            </th>
						    <td nowrap="nowrap" class="tdleft"><input name="authorNm" id="authorNm" type="text" value="<c:out value='${authorManage.authorNm}'/>" maxLength="50" size="40" title="권한명" />&nbsp;<form:errors path="authorNm" /></td>
						  ...
						  <tr>  
						    ...
						    <td nowrap="nowrap" class="tdleft"><input name="authorDc" id="authorDc" type="text" value="<c:out value='${authorManage.authorDc}'/>" maxLength="50" size="50" title="설명" /></td>
						  </tr>
						  ...
						  <tr>  
						    ...
						    <td nowrap="nowrap" class="tdleft"><input name="authorCreatDe" id="authorCreatDe" type="text" value="<c:out value='${authorManage.authorCreatDe}'/>" maxLength="50" size="20" readonly="readonly" title="등록일자"/></td>
						  </tr>
                    ...
                    <div class="list4">
                    	...
                    	<c:if test="${registerFlag == 'UPDATE'}">
	                    	...
	                    	<span class="btnblue"><a href="#LINK" onclick="javascript:fncAuthorDelete()" style="selector-dummy:expression(this.hideFocus=false);">삭제 ▶</a></span>&nbsp;
                    	</c:if>
                    </div>
                    <!-- 버튼 끝 --> 
