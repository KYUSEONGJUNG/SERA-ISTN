...
<!--                 </div> -->
                <form:form commandName="roleManage" method="post" >  
                    ...
                    <div class="inputtb" >
                        <table width="980" border="0" cellpadding="0" cellspacing="0" summary="롤 등록 테이블입니다.롤 코드,롤 명,롤 패턴,설명,롤 타입,롤 Sort,등록일자의 정보를 담고 있습니다.">
						  <tr>
						  ...
						  <tr style="display:none">
						    ...
						    <td nowrap="nowrap" class="tdleft"><input name="roleCode" id="roleCode" type="text" value="<c:out value='${roleManage.roleCode}'/>" size="30" title="롤 코드"/></td>
						  </tr>
						  ...
						  <tr>
						    ...
						    <td nowrap="nowrap" class="tdleft"><input name="roleNm" id="roleNm" type="text" value="<c:out value='${roleManage.roleNm}'/>" maxLength="50" size="30" title="롤명"/>&nbsp;<form:errors path="roleNm" /></td>
						  </tr>
						  ...
						  <tr>
						    ...
						    <td nowrap="nowrap" class="tdleft"><input name="rolePtn" id="rolePtn" type="text" value="<c:out value='${roleManage.rolePtn}'/>" maxLength="50" size="50" title="롤패턴"/>&nbsp;<form:errors path="rolePtn" /></td>
						  </tr>
						  ...
						  <tr>
						    <th class="tdblue" width="20%" scope="row"  nowrap="nowrap">설명</th>
						    <td nowrap="nowrap" class="tdleft"><input name="roleDc" id="roleDc" type="text" value="<c:out value='${roleManage.roleDc}'/>" maxLength="50" size="50" title="설명"/></td>
						  </tr>
						  ...
						  <tr>
						    ...
						    <td nowrap="nowrap" class="tdleft"><input name="roleSort" id="roleSort" type="text" value="<c:out value='${roleManage.roleSort}'/>" maxLength="50" size="30" title="롤sort"/></td>
						  </tr>  
						  <tr>
						    <th class="tdblue" width="20%" scope="row"  nowrap="nowrap">등록일자</th>
						    <td nowrap="nowrap" class="tdleft"><input name="roleCreatDe" id="roleCreatDe" type="text" value="<c:out value='${roleManage.roleCreatDe}'/>" maxLength="50" size="20" readonly="readonly" title="등록일자"/></td>
						  </tr>
                    ...
                    <div class="list4">
                    	...
                    	<c:if test="${registerFlag == 'UPDATE'}">
	                    	<a href="#LINK" onclick="javascript:fncRoleUpdate()" style="selector-dummy:expression(this.hideFocus=false);"><spring:message code="button.save" /> ▶</a></span>&nbsp;
	                    	<a href="#LINK" onclick="javascript:fncRoleDelete()" style="selector-dummy:expression(this.hideFocus=false);"><spring:message code="button.delete" /> ▶</a></span>&nbsp;
                    	</c:if>
                    </div>
                    <!-- 버튼 끝 --> 
