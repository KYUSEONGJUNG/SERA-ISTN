    ...
    <!-- //header 끝 --> 
            ...
            <div id="contents">
                ...
                <form:form commandName="cmmnClCode" name="cmmnClCode" method="post">
                    ...
                    <div class="inputtb" >
                        <table width="980" border="0" cellpadding="0" cellspacing="0" summary="분류코드, 분류코드명, 분류코드설명, 사용여부를 입력하는 공통분류코드 등록 테이블이다.">
						  <tr>
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                        ...
                        <tr> 
                          <td>
                            <a href="#LINK" onclick="fn_egov_list_CmmnClCode(); return false;">목록</a>
                          </td>
                          <td width="10"></td>
                          <td>
