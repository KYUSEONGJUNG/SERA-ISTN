...
<!--                 </div> -->
                ...
                <div class="list2">
			      	<ul>
			        	<li><img src="<c:url value='/' />images/sr/icon_home.gif"/> &nbsp;HOME > 기반관리 > 공통코드관리 > 공통코드 수정</li>
			        </ul>
			    </div>	
<!--                 <div id="search_field"> -->
...
<!--                 </div> -->
                ...
                <form:form commandName="cmmnCode" name="cmmnCode" method="post" >
                    ...
                    <div class="inputtb" >
                        <table width="980" border="0" cellpadding="0" cellspacing="0" summary="코드명, 코드ID설명, 사용여부를 수정하는 공통코드 수정 테이블이다.">
<!--                           <tr>  -->
<%--                             <th width="20%" height="23" class="tdblue" scope="row" nowrap="nowrap" >분류코드명<img src="<c:url value='/'/>images/required.gif" width="15" height="15" alt="필수" /></th> --%>
...
<!--                           </tr> -->
                          ...
                          <tr> 
                          <tr>
                            <th width="20%" height="23" class="tdblue" scope="row" nowrap="nowrap" >코드ID<img src="<c:url value='/'/>images/required.gif" width="15" height="15" alt="필수" /></th>          
                          ...
                          <tr>
                            <th width="20%" height="23" class="tdblue" scope="row" nowrap="nowrap" ><label for="codeIdNm">코드명</label><img src="<c:url value='/'/>images/required.gif" width="15" height="15" alt="필수" /></th>          
                          ...
                          <tr> 
                            <th width="20%" height="23" class="tdblue" scope="row" nowrap="nowrap" ><label for="useAt">사용여부</label><img src="<c:url value='/'/>images/required.gif" width="15" height="15" alt="필수" /></th>
                    ...
                    <div class="list4">
                    	...
                    	<span class="btnblue"><a href="#LINK" onclick="fn_egov_modify_CmmnCode(document.cmmnCode); return false;"><spring:message code="button.save" /> ▶</a></span>&nbsp;
                    </div>
                    <!-- 버튼 끝 -->  
...
<!--                           <td width="10"></td> -->
<!--                           <td> -->
<!--                             <a href="#LINK" onclick="fn_egov_modify_CmmnCode(document.cmmnCode); return false;">저장</a>  -->
<!--                           </td> -->
<!--                         </tr> -->
<!--                         </table> -->
<!--                     </div> -->
