<%--
  Class Name : EgovSrMinbyProcessSttus.jsp
  Description : SR월별 처리현황
...
<title><spring:message code='sr.monthlyProcessingStatus'/></title>
	...
	SBGrid3.$(document).ready(function() {
	 ...
	 async function loadData(payload = {}, dataType = "json") {
		 return new Promise((resolve, reject) => {
			 ...
			 $("#searchAt").val("Y");
			 $.ajax({				 
				 url : "<c:url value='/select/mprcsts/selectSrMinbyProcessSttus.do'/>",
				 type : "POST",
		...
		let gridConfig = {
		    ...
		    columns: [
		        { field: 
		        	...
		        	, caption: "<spring:message code='sr.module' />", editable: false, type: 'text', valign: 'center' , width:8, unit:'%'},
 ...
 */
 function fnExcelReport(){
     document.listForm.action = "<c:url value='/sts/mprcsts/EgovMinbyProcessSttusExcelReport.do'/>";
     document.listForm.submit();
 }
</script>
</head>
    ...
    <!-- //header 끝 --> 
        ...
        <div class="sr-contents-area">
        	<div class="sr-contents">
	            ...
	            <form id="listForm" name="listForm" action="<c:url value='/sts/mprcsts/selectSrMinbyProcessSttus.do'/>" method="post">
		            ...
		            <div class="sr-table-wrap">
		            	<table class="sr-table">
		            		...
		            		<tbody>					        
								...
								<tr>
									<th>
		                               <sbux-label id="table_label3" name="table_label3" uitype="normal" text="<spring:message code='sr.totalingStandard'/>" class=""></sbux-label>
			                        </th>
			                  		<td>
			                  			<sbux-radio id="searchDateCondition" name="searchDateCondition" uitype="normal" jsondata-ref="totalJsonData"></sbux-radio>
			                  		</td>
			                  		<th>
