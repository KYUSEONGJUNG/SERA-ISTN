                        ...
                        <div class="sf_start">
                            <ul id="search_first_ul">
                                <li>
				                    ...
				                    <a href="#noscript" onclick="fn_egov_NormalCalendar(document.listForm, document.listForm.fromDate, document.listForm.fDate,'','<c:url value='/sym/ccm/EgovselectNormalCalendar.do'/>'); return false;" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/sr/icon_calendar.gif' />" alt="달력(새창)"></a>
				                    &nbsp;~&nbsp;<input type="text" name="tDate" value="" size="10"  title="종료일자(새창)" id="tDate" />
				                    <a href="#noscript" onclick="fn_egov_NormalCalendar(document.listForm, document.listForm.toDate, document.listForm.tDate,'','<c:url value='/sym/ccm/EgovselectNormalCalendar.do'/>'); return false;" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/sr/icon_calendar.gif' />" alt="달력(새창)"></a>
                                </li>
                                <li>
