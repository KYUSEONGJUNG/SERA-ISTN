 ...
 <table width="700" cellpadding="8" class="table-search" border="0">
	 ...
	 <tr>
	  ...
	  <td>
	      ...
	      <a href="#LINK" onclick="fn_egov_NormalCalendar(document.frm, document.frm.searchBgnDe, document.frm.searchBgnDeView); return false;"
	     ...
	     <input name="searchEndDeView" type="text" size="10" value="${searchVO.searchEndDeView}"  readOnly
	      ...
	      <a href="#LINK" onclick="fn_egov_NormalCalendar(document.frm, document.frm.searchEndDe, document.frm.searchEndDeView); return false;"
	    	style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" alt="달력창팝업버튼이미지"
		    width="15" height="15"></a>
		</td>
	  ...
	  <th>
	   <table border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      ...
	      <a href="#LINK" onclick="fn_egov_select_sysLog('1'); return false;">조회</a>
	      </td>
	...
	<td class="lt_text3" colspan="8">
	 ...
	 <c:forEach var="result" items="${resultList}" varStatus="status">
	  <tr>
	    ...
	    <td class="tdwc" nowrap><c:out value="${(searchVO.pageIndex-1) * searchVO.pageSize + status.count}"/></td>
	    <td class="tdwc" nowrap><c:out value="${result.requstId}"/></td>
	    <td class="tdwc" nowrap><c:out value="${result.occrrncDe}"/></td>
	    <td class="tdwc" nowrap><c:out value="${result.methodNm}"/></td>
	    <td class="tdwc" nowrap><c:out value="${result.processSeCodeNm}"/></td>
	    <td class="tdwc" nowrap><c:out value="${result.processTime}"/></td>
	    <td class="tdwc" nowrap><c:out value="${result.rqsterNm}"/></td>
	    <td class="tdwc" nowrap>
	    <a href="#LINK" onclick="fn_egov_inqire_sysLog('<c:out value="${result.requstId}"/>'); return false;"
