...
<!--                 </div> -->
                <form:form commandName="menuManageVO" name="menuManageVO" method="post" action="${pageContext.request.contextPath}/sym/mnu/mpm/EgovMenuRegistInsert.do">
                    ...
                    <div class="inputtb" >
                        <table width="980" border="0" cellpadding="0" cellspacing="0" summary="메뉴 등록화면">
						  <tr>
				              <td colspan="4" bgcolor="#0257a6" height="2"></td>
				          </tr>
						  <tr> 
						    <th width="15%" height="23" class="tdblue" scope="row"><label for="menuNo">메뉴번호</label><img src="<c:url value='/'/>images/required.gif" width="15" height="15" alt="필수" /></th>
						    <td width="35%" nowrap="nowrap">
						      &nbsp;
						      <form:input path="menuNo" size="10" maxlength="10" title="메뉴No"/>
						      <form:errors path="menuNo" />
						    </td>
						    <th width="15%" height="23" class="tdblue" scope="row"><label for="menuOrdr">메뉴순서</label><img src="<c:url value='/'/>images/required.gif" width="15" height="15" alt="필수" /></th>
						    <td width="35%" nowrap="nowrap">
						      &nbsp;
						  ...
						  <tr> 
						    <th width="15%" height="23" class="tdblue" scope="row"><label for="menuNm">메뉴명</label><img src="<c:url value='/'/>images/required.gif" width="15" height="15" alt="필수" /></th>
						    <td width="35%" nowrap="nowrap">
						      &nbsp;
						      <form:input path="menuNm" size="30"  maxlength="30" title="메뉴명" />
						      <form:errors path="menuNm" />
						    </td>
						    <th width="15%" height="23" class="tdblue" scope="row"><label for="upperMenuId">상위메뉴번호</label><img src="<c:url value='/'/>images/required.gif" width="15" height="15" alt="필수" /></th>
						    <td width="35%" nowrap="nowrap">
						      &nbsp;
						  ...
						  <tr> 
						    <th width="15%" height="23" class="tdblue" scope="row"><label for="progrmFileNm">프로그램파일명</label><img src="<c:url value='/'/>images/required.gif" width="15" height="15" alt="필수" /></th>
						  ...
						  <tr> 
						    <th width="15%" height="23" class="tdblue" scope="row"><label for="relateImageNm">관련이미지명</label></th>
						    <td width="35%" nowrap="nowrap">
						          &nbsp;
						          <form:input path="relateImageNm" size="30"  maxlength="30" title="관련이미지명"/>
						          <form:errors path="relateImageNm" />
						    </td>
						    <th width="15%" height="23" class="tdblue" scope="row"><label for="relateImagePath">관련이미지경로</label></th>
						    <td width="35%" nowrap="nowrap">
						          &nbsp;
						  ...
						  <tr> 
						    <th width="15%" height="23" class="tdblue" scope="row"><label for="menuDc">메뉴설명</label></th>
                    ...
                    <div class="list4">
                    	<span class="btnblue"><a href="<c:url value='/sym/mnu/mpm/EgovMenuManageSelect.do'/>" onclick="javascript:selectList(); return false;"><spring:message code="button.list" /> ▶</a></span>&nbsp;
                    	<span class="btnblue"><a href="#LINK" onclick="javascript:insertMenuManage(document.getElementById('menuManageVO')); return false;"><spring:message code="button.save" /> ▶</a></span>&nbsp;
                    </div>
                    <!-- 버튼 끝 -->  
