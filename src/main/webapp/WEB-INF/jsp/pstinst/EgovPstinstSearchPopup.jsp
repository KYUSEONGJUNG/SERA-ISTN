...
<body>
<form name="pForm" action="<c:url value='pstinst/EgovPstinstSearchPopup.do'/>">
...
-->
<!-- FIREFOX -->
<iframe name="ifcal" title="고객사찾기 팝업" src="<c:url value='/pstinst/EgovPstinstSearchList.do'/>" style="width:680px; height:530px;" frameborder=0></iframe>
</body>
</html>