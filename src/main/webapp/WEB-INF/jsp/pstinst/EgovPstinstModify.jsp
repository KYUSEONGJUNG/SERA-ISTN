...
<div id="wrapper">
    ...
    <!-- container 시작 -->
            ...
            <div id="contents">
               <div class="list2">
			      	<ul>
			        	<li><img src="<c:url value='/' />images/sr/icon_home.gif"/> &nbsp;HOME > 코드관리 > 우편번호 수정</li>
			        </ul>
			   </div>
                <!-- 검색 필드 박스 시작 -->
				<form:form commandName="zip" name="zip" method="post">
                    ...
                    <div class="inputtb" >
                        <table width="980" border="0" cellpadding="0" cellspacing="0" summary="리건물명과 번지동호를 수정하는 우편번호 수정 테이블이다.">
						  ...
						  <tr>
						    <th width="20%" height="23" scope="row" nowrap >읍면동명</th>          
						    <td width="80%" nowrap="nowrap" class="tdleft">
						  ...
						  <tr>
						    <th width="20%" height="23" nowrap scope="row" ><label for="liBuldNmOld">리건물명(구)</label></th>          
						    <td width="80%" nowrap="nowrap" class="tdleft">
						  ...
						  <tr>
						    <th width="20%" height="23" scope="row" nowrap ><label for="lnbrDongHoOld">번지동호(구)</label></th>          
						    <td width="80%" nowrap="nowrap" class="tdleft">
                    ...
                    <div class="list4">
                    	<span class="btnblue"><a href="#LINK" onclick="JavaScript:fn_egov_list_Zip(); return false;"><spring:message code="button.list" /> ▶</a></span>&nbsp;
